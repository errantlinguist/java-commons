...
public final class ClassName {
	...
	public static final String getThreadClassName(final String threadName) {
		...
		final StackTraceElement[] stackTrace = StackTrace.getStackTrace(threadName);
		if (stackTrace != null) {
			result = stackTrace[stackTrace.length - 1].getClassName();
		}
	 ...
	 * @see <a href=
	 *      "http://stackoverflow.com/a/940035">http://stackoverflow.com/a/940035</a>
	 */
	private static final String getMainClassNameSystemEnvironmentProperty() {
		return SystemEnvironment.getSystemEnvironmentProperty(JAVA_MAIN_CLASS_PROPERTY_NAME);
	}
