...
public final class StackTrace {
	 ...
	 */
	public static final StackTraceElement[] getStackTrace(final String threadName) {
		StackTraceElement[] result = null;

		final Map<Thread, StackTraceElement[]> allStackTraces = Thread.getAllStackTraces();
		for (final Entry<Thread, StackTraceElement[]> stackTrace : allStackTraces.entrySet()) {
